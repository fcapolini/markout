...
Find kits in `.markout/kits/` as well as `node_modules/`, at the docroot and
...
written to a directory, and available on the middleware as `client: true`.
